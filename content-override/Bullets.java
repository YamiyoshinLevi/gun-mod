...
public class Bullets implements ContentList{
    ...
    //standard
    standardCopper, standardLevi, standardOvei, standardDense, standardThorium, standardHoming, standardIncendiary,
    ...
    public void load(){
        ...
        standardLevi = new BasicBulletType(5.5f, 50){{
            width = 7f;
            height = 9f;
            lifetime = 1000f;
            shootEffect = Fx.shootSmall;
        ...
        standardOevi = new BasicBulletType(5.5f, 150){{
            width = 7f;
            height = 9f;
            lifetime = 1000f;
            shootEffect = Fx.shootSmall;
